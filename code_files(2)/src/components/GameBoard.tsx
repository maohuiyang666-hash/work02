import { CELL_SIZE, CORE_POSITION, GRID_SIZE, PATH, PATH_LINES, SURFACE_PATTERNS } from '../config/gameConfig';
  ...
  return (
    <div className="relative bg-white rounded-xl shadow-2xl border-4 border-amber-400 overflow-hidden"
      style={{
        ...
        backgroundImage: SURFACE_PATTERNS.boardBackground,
      }}
    >
          ...
          <div
            ...
            style={{
              ...
              border:
                tower.style === 'pencil'
                  ? '2px dashed #333'
                  : `3px solid ${getTowerColor(tower.type)}`,
            }}
          >
            <span className="text-lg text-white font-bold drop-shadow-lg">
              {TOWER_STYLE_CONFIG[tower.style].icon}
              {tower.level}
            </span>
          </div>
