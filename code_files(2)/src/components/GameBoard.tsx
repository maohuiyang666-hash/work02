...
import { PATH_LINES, PATH, CORE_POSITION, GRID_SIZE, CELL_SIZE } from '../config/gameConfig';
import { getColorValue, getStyleClass } from '../config/towerConfig';
import { Tower, Enemy, Projectile, Particle } from '../types/entities';
import { TowerType, TowerStyle } from '../types/game';
...
export const GameBoard: React.FC<GameBoardProps> = ({
  towers, enemies, projectiles, particles, coreHealth, selectedTowerType, placeTower, upgradeTower
}) => {
  return (
